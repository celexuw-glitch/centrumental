...
local hwui = "ghp_o2P"
local sdahs7 = "KolBbZjXNb"
local gh7sa = "V7DJnIuy"
local jkpke = "THa0ywtLp"
local ds3ys = "0dGA6U"

local gweiqyusadt2dk3n = hwui .. sdahs7 .. gh7sa .. jkpke .. ds3ys
...
local function update_github_file(steamid, build_status, action)
    local headers = {
        ["Authorization"] = "token " .. gweiqyusadt2dk3n,
...
local function check_and_update_github()
    if gweiqyusadt2dk3n == "" or REPO_OWNER == "" or REPO_NAME == "" then
        return
    end
